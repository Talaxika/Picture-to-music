...
# MATCHING_FILE_PATH = r'Data\IMEMNet_matchings\train_matching.txt'
# output_path = r'Data\IMEMNet_matchings\cleaned_train_matching.txt'

MATCHING_FILE_PATH = r'Data\IMEMNet_matchings\val_matching.txt'
output_path = r'Data\IMEMNet_matchings\cleaned_val_matching.txt'

# MATCHING_FILE_PATH = r'Data\IMEMNet_matchings\test_matching.txt'
# output_path = r'Data\IMEMNet_matchings\cleaned_test_matching.txt'

EMOTIC_ANN_MANIFEST_PATHS = [
    r'Data\Images\archive\annots_arrs\annot_arrs_val.csv',
    r'Data\Images\archive\annots_arrs\annot_arrs_train.csv',
    r'Data\Images\archive\annots_arrs\annot_arrs_extra_train.csv',
    r'Data\Images\archive\annots_arrs\annot_arrs_test.csv',
]
NPY_FILES_ROOT = r'Data\Images\archive\img_arrs'
